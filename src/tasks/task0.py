...
p_r1 = 2/5 #cnt_red / cnt_both
print(f'Die erste Kugel ist mit einer Wahrscheinlichkeit von p = {p_r1} eine rote Kugel.')

# b.2) g2: Wahrscheinlichkeit dafür, dass die zweite Kugel gelb ist
p_g2 = 2/5 * 2/4 + 2/4 * 1/4 #cnt_yellow/cnt_both * (cnt_yellow-1)/(cnt_both-1) + cnt_red/cnt_both * cnt_yellow/(cnt_both-1)
print(f'Die zweite Kigel ist mit einer Wahrscheinlichekeit von p = {p_g2} eine gelbe Kugel.')

# c) P(A|B) = P(A ∩ B) / P(B)
p_both = 2/5 * 2/4 #cnt_red/cnt_both * (cnt_yellow-1)/(cnt_both-1)
